...
class StatisticsMonthlyScreen extends ConsumerWidget {
  const StatisticsMonthlyScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final statisticsState = ref.watch(statisticsProvider('monthly'));
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ref.read(statisticsProvider('monthly').notifier).loadStatistics(
                userId: 1,
                date: '2025-02-01',
                period: 'monthly',
              );
